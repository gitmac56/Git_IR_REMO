// ======================================================================
// C4245AZI-483.v generated from TopDesign.cysch
// 09/12/2020 at 06:01
...
module top ;
	...
	wire [0:0] tmpOE__M_BR_net;
	wire [0:0] tmpFB_0__M_BR_net;
	wire [0:0] tmpIO_0__M_BR_net;
	wire [0:0] tmpINTERRUPT_0__M_BR_net;
	electrical [0:0] tmpSIOVREF__M_BR_net;

	cy_psoc3_pins_v1_10
		#(.id("20b1e655-7ad5-43c3-ba82-b58b4ebc2a30"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M_BR
		 (.oe(tmpOE__M_BR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_BR_net[0:0]}),
		  .io({tmpIO_0__M_BR_net[0:0]}),
		  .siovref(tmpSIOVREF__M_BR_net),
		  .interrupt({tmpINTERRUPT_0__M_BR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_BR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M_FR_net;
	wire [0:0] tmpFB_0__M_FR_net;
	wire [0:0] tmpIO_0__M_FR_net;
	wire [0:0] tmpINTERRUPT_0__M_FR_net;
	electrical [0:0] tmpSIOVREF__M_FR_net;

	cy_psoc3_pins_v1_10
		#(.id("e8aa2197-e639-45e6-8591-86dffa68ad52"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M_FR
		 (.oe(tmpOE__M_FR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_FR_net[0:0]}),
		  .io({tmpIO_0__M_FR_net[0:0]}),
		  .siovref(tmpSIOVREF__M_FR_net),
		  .interrupt({tmpINTERRUPT_0__M_FR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_FR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M_BL_net;
	wire [0:0] tmpFB_0__M_BL_net;
	wire [0:0] tmpIO_0__M_BL_net;
	wire [0:0] tmpINTERRUPT_0__M_BL_net;
	electrical [0:0] tmpSIOVREF__M_BL_net;

	cy_psoc3_pins_v1_10
		#(.id("9167f589-58cc-43cd-8494-0673ebd28ae6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M_BL
		 (.oe(tmpOE__M_BL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_BL_net[0:0]}),
		  .io({tmpIO_0__M_BL_net[0:0]}),
		  .siovref(tmpSIOVREF__M_BL_net),
		  .interrupt({tmpINTERRUPT_0__M_BL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_BL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M_FL_net;
	wire [0:0] tmpFB_0__M_FL_net;
	wire [0:0] tmpIO_0__M_FL_net;
	wire [0:0] tmpINTERRUPT_0__M_FL_net;
	electrical [0:0] tmpSIOVREF__M_FL_net;

	cy_psoc3_pins_v1_10
		#(.id("6fd2a80e-2591-486b-b335-7f85760df681"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M_FL
		 (.oe(tmpOE__M_FL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M_FL_net[0:0]}),
		  .io({tmpIO_0__M_FL_net[0:0]}),
		  .siovref(tmpSIOVREF__M_FL_net),
		  .interrupt({tmpINTERRUPT_0__M_FL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M_FL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__IR_net;
	wire [0:0] tmpIO_0__IR_net;
	wire [0:0] tmpINTERRUPT_0__IR_net;
	electrical [0:0] tmpSIOVREF__IR_net;
	...
	cy_psoc3_pins_v1_10
		...
		IR
		 (.oe(tmpOE__IR_net),
		  .y({1'b0}),
		  .fb({Net_242}),
		  .io({tmpIO_0__IR_net[0:0]}),
		  .siovref(tmpSIOVREF__IR_net),
		  .interrupt({tmpINTERRUPT_0__IR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Timer2.DeviceFamily = "PSoC4";
    defparam Timer2.InterruptOnCapture = 0;
    defparam Timer2.InterruptOnTC = 0;
    defparam Timer2.Resolution = 8;
    defparam Timer2.SiliconRevision = "17";

	wire [0:0] tmpOE__Ch0_net;
	wire [0:0] tmpFB_0__Ch0_net;
	wire [0:0] tmpIO_0__Ch0_net;
	wire [0:0] tmpINTERRUPT_0__Ch0_net;
	electrical [0:0] tmpSIOVREF__Ch0_net;

	cy_psoc3_pins_v1_10
		#(.id("d2586367-7f91-4b19-934c-cfb4958c94bf"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Ch0
		 (.oe(tmpOE__Ch0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ch0_net[0:0]}),
		  .io({tmpIO_0__Ch0_net[0:0]}),
		  .siovref(tmpSIOVREF__Ch0_net),
		  .interrupt({tmpINTERRUPT_0__Ch0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ch0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ch1_net;
	wire [0:0] tmpFB_0__Ch1_net;
	wire [0:0] tmpIO_0__Ch1_net;
	wire [0:0] tmpINTERRUPT_0__Ch1_net;
	electrical [0:0] tmpSIOVREF__Ch1_net;

	cy_psoc3_pins_v1_10
		#(.id("fb6975a7-d2c7-4d33-836a-e68c6e54ce8a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Ch1
		 (.oe(tmpOE__Ch1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ch1_net[0:0]}),
		  .io({tmpIO_0__Ch1_net[0:0]}),
		  .siovref(tmpSIOVREF__Ch1_net),
		  .interrupt({tmpINTERRUPT_0__Ch1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ch1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
