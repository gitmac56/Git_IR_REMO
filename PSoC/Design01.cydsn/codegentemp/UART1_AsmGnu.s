...
.global UART1_pinNumber
.global UART1_pinPortNumber
...
.func UART1_PutChar, UART1_PutChar
.type UART1_PutChar, %function
.thumb_func
UART1_PutChar:
...
bitTxLoop:
    ...
    .align 5
PIN_NUMBER:
    .word UART1_pinNumber
PORT_NUMBER:
    .word UART1_pinPortNumber
PORT_DR_ADDRESS:
    .word UART1_pinDrAdress
FREQ:
    .word cydelayFreqHz
BAUD_RATE:
    .word 115200
