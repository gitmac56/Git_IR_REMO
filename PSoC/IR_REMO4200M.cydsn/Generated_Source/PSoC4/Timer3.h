...
#if !defined(CY_TIMER_Timer3_H)
#define CY_TIMER_Timer3_H
...
uint8  Timer3_ReadPeriod(void) ;
void    Timer3_WritePeriod(uint8 period) ;
uint8  Timer3_ReadCounter(void) ;
void    Timer3_WriteCounter(uint8 counter) ;
uint8  Timer3_ReadCapture(void) ;
...
#define Timer3_INIT_PERIOD             255u
#define Timer3_INIT_CAPTURE_MODE       ((uint8)((uint8)1u << Timer3_CTRL_CAP_MODE_SHIFT))
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer3_CONTROL             (* (reg8 *) Timer3_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Timer3_CAPTURE_LSB         (* (reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer3_CAPTURE_LSB_PTR       ((reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer3_PERIOD_LSB          (* (reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer3_PERIOD_LSB_PTR        ((reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer3_COUNTER_LSB         (* (reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
        #define Timer3_COUNTER_LSB_PTR       ((reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
    #elif(Timer3_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Timer3_CAPTURE_LSB         (* (reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__F0_REG )
            #define Timer3_CAPTURE_LSB_PTR       ((reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__F0_REG )
            #define Timer3_PERIOD_LSB          (* (reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__D0_REG )
            #define Timer3_PERIOD_LSB_PTR        ((reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__D0_REG )
            #define Timer3_COUNTER_LSB         (* (reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
            #define Timer3_COUNTER_LSB_PTR       ((reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Timer3_CAPTURE_LSB         (* (reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG )
            #define Timer3_CAPTURE_LSB_PTR       ((reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG )
            #define Timer3_PERIOD_LSB          (* (reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG )
            #define Timer3_PERIOD_LSB_PTR        ((reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG )
            #define Timer3_COUNTER_LSB         (* (reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG )
            #define Timer3_COUNTER_LSB_PTR       ((reg16 *) Timer3_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Timer3_Resolution <= 24u)/* 24-bit Timer */
        #define Timer3_CAPTURE_LSB         (* (reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer3_CAPTURE_LSB_PTR       ((reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__F0_REG )
        #define Timer3_PERIOD_LSB          (* (reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer3_PERIOD_LSB_PTR        ((reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__D0_REG )
        #define Timer3_COUNTER_LSB         (* (reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
        #define Timer3_COUNTER_LSB_PTR       ((reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Timer3_CAPTURE_LSB         (* (reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__32BIT_F0_REG )
            #define Timer3_CAPTURE_LSB_PTR       ((reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__32BIT_F0_REG )
            #define Timer3_PERIOD_LSB          (* (reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__32BIT_D0_REG )
            #define Timer3_PERIOD_LSB_PTR        ((reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__32BIT_D0_REG )
            #define Timer3_COUNTER_LSB         (* (reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__32BIT_A0_REG )
            #define Timer3_COUNTER_LSB_PTR       ((reg32 *) Timer3_TimerUDB_sT8_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Timer3_COUNTER_LSB_PTR_8BIT       ((reg8 *) Timer3_TimerUDB_sT8_timerdp_u0__A0_REG )
