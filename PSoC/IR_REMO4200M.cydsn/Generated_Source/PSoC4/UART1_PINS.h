...
#define UART1_REMOVE_CTS_SCLK_PIN      (1u)
#define UART1_REMOVE_RTS_SS0_PIN      (1u)
...
#define UART1_CTS_SCLK_PIN     (0u == UART1_REMOVE_CTS_SCLK_PIN)
#define UART1_RTS_SS0_PIN     (0u == UART1_REMOVE_RTS_SS0_PIN)
...
****************************************/
    ...
    #include "UART1_uart_cts_spi_sclk.h"
#endif /* (UART1_CTS_SCLK) */

#if (UART1_RTS_SS0_PIN)
    #include "UART1_uart_rts_spi_ss0.h"
...
#if (UART1_CTS_SCLK_PIN)
    #define UART1_CTS_SCLK_HSIOM_REG   (*(reg32 *) UART1_uart_cts_spi_sclk__0__HSIOM)
    #define UART1_CTS_SCLK_HSIOM_PTR   ( (reg32 *) UART1_uart_cts_spi_sclk__0__HSIOM)
    
    #define UART1_CTS_SCLK_HSIOM_MASK      (UART1_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define UART1_CTS_SCLK_HSIOM_POS       (UART1_uart_cts_spi_sclk__0__HSIOM_SHIFT)
    #define UART1_CTS_SCLK_HSIOM_SEL_GPIO  (UART1_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define UART1_CTS_SCLK_HSIOM_SEL_I2C   (UART1_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define UART1_CTS_SCLK_HSIOM_SEL_SPI   (UART1_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define UART1_CTS_SCLK_HSIOM_SEL_UART  (UART1_uart_cts_spi_sclk__0__HSIOM_UART)
#endif /* (UART1_CTS_SCLK_PIN) */

#if (UART1_RTS_SS0_PIN)
    #define UART1_RTS_SS0_HSIOM_REG   (*(reg32 *) UART1_uart_rts_spi_ss0__0__HSIOM)
    #define UART1_RTS_SS0_HSIOM_PTR   ( (reg32 *) UART1_uart_rts_spi_ss0__0__HSIOM)
    
    #define UART1_RTS_SS0_HSIOM_MASK      (UART1_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define UART1_RTS_SS0_HSIOM_POS       (UART1_uart_rts_spi_ss0__0__HSIOM_SHIFT)
    #define UART1_RTS_SS0_HSIOM_SEL_GPIO  (UART1_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define UART1_RTS_SS0_HSIOM_SEL_I2C   (UART1_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define UART1_RTS_SS0_HSIOM_SEL_SPI   (UART1_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(UART1_CY_SCBIP_V0 || UART1_CY_SCBIP_V1)
    #define UART1_RTS_SS0_HSIOM_SEL_UART  (UART1_uart_rts_spi_ss0__0__HSIOM_UART)
...
#define UART1_CTS_SCLK_PIN_INDEX       (2u)
#define UART1_RTS_SS0_PIN_INDEX       (3u)
...
#define UART1_CTS_SCLK_PIN_MASK     ((uint32) 0x01u << UART1_CTS_SCLK_PIN_INDEX)
#define UART1_RTS_SS0_PIN_MASK     ((uint32) 0x01u << UART1_RTS_SS0_PIN_INDEX)
...
#if (UART1_RTS_SS0_PIN)
    #define UART1_CHECK_RTS_SS0_PIN_USED \
                (UART1_PIN_DM_ALG_HIZ != \
                    UART1_GET_P4_PIN_DM(UART1_uart_rts_spi_ss0_PC, \
                                                   UART1_uart_rts_spi_ss0_SHIFT))
#endif /* (UART1_RTS_SS0_PIN) */
...
#define UART1_REMOVE_SCLK_PIN                UART1_REMOVE_CTS_SCLK_PIN
#endif /* UART1_REMOVE_SCLK_PIN */
#ifndef UART1_REMOVE_SS0_PIN
#define UART1_REMOVE_SS0_PIN                 UART1_REMOVE_RTS_SS0_PIN
...
#define UART1_SCLK_PIN               UART1_CTS_SCLK_PIN
#endif /* UART1_SCLK_PIN */
#ifndef UART1_SS0_PIN
#define UART1_SS0_PIN                UART1_RTS_SS0_PIN
#endif /* UART1_SS0_PIN */
    ...
    #define UART1_SCLK_HSIOM_REG     UART1_CTS_SCLK_HSIOM_REG
    #define UART1_SCLK_HSIOM_PTR     UART1_CTS_SCLK_HSIOM_PTR
    #define UART1_SCLK_HSIOM_MASK    UART1_CTS_SCLK_HSIOM_MASK
    #define UART1_SCLK_HSIOM_POS     UART1_CTS_SCLK_HSIOM_POS
    #endif /* UART1_SCLK_HSIOM_REG */
#endif /* (UART1_SCLK_PIN) */

#if (UART1_SS0_PIN)
    #ifndef UART1_SS0_HSIOM_REG
    #define UART1_SS0_HSIOM_REG      UART1_RTS_SS0_HSIOM_REG
    #define UART1_SS0_HSIOM_PTR      UART1_RTS_SS0_HSIOM_PTR
    #define UART1_SS0_HSIOM_MASK     UART1_RTS_SS0_HSIOM_MASK
    #define UART1_SS0_HSIOM_POS      UART1_RTS_SS0_HSIOM_POS
...
#define UART1_SCLK_PIN_INDEX             UART1_CTS_SCLK_PIN_INDEX
#endif /* UART1_SCLK_PIN_INDEX */
#ifndef UART1_SS0_PIN_INDEX
#define UART1_SS0_PIN_INDEX              UART1_RTS_SS0_PIN_INDEX
...
#define UART1_SCLK_PIN_MASK             UART1_CTS_SCLK_PIN_MASK
#endif /* UART1_SCLK_PIN_MASK */
#ifndef UART1_SS0_PIN_MASK
#define UART1_SS0_PIN_MASK              UART1_RTS_SS0_PIN_MASK
