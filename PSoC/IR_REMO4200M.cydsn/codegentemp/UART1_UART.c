...
void UART1_UartPostEnable(void)
{
        ...
        if (UART1_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            if (UART1_CHECK_RTS_SS0_PIN_USED)
            {
                /* Set SCB UART to drive the output pin */
                UART1_SET_HSIOM_SEL(UART1_RTS_SS0_HSIOM_REG, UART1_RTS_SS0_HSIOM_MASK,
                                               UART1_RTS_SS0_HSIOM_POS, UART1_RTS_SS0_HSIOM_SEL_UART);
            }
...
void UART1_UartStop(void)
{
        ...
        if (UART1_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            if (UART1_CHECK_RTS_SS0_PIN_USED)
            {
                ...
                UART1_uart_rts_spi_ss0_Write(UART1_GET_UART_RTS_INACTIVE);

                /* Set GPIO to drive output pin */
                UART1_SET_HSIOM_SEL(UART1_RTS_SS0_HSIOM_REG, UART1_RTS_SS0_HSIOM_MASK,
                                               UART1_RTS_SS0_HSIOM_POS, UART1_RTS_SS0_HSIOM_SEL_GPIO);
            }
        #endif /* (UART1_RTS_SS0_PIN) */
    #endif /* !(UART1_CY_SCBIP_V0 || UART1_CY_SCBIP_V1) */
